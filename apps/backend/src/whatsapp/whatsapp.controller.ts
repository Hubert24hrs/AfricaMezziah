...
export class WhatsappController {
    ...
    verifyWebhook(
        ...
        const VERIFY_TOKEN = process.env.WHATSAPP_VERIFY_TOKEN || 'africa-mezziah-verify';
    ...
    async handleMessage(@Body() body: any) {
        try {
            ...
            const productData = await this.aiService.parseProductFromWhatsApp(messageText, imageUrl);
