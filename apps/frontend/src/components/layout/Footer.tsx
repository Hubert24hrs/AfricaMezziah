...
const footerLinks = {
    shop: [
        ...
        { href: "/shop/traditional", label: "Traditional Wear" },
...
export default function Footer() {
    return (
        <footer className="bg-dark-950 text-cream py-16 mt-20">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-cream/60 mb-6">
                            Celebrating African elegance with modern sophistication. Premium fashion for the bold, beautiful woman.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="p-2 glass rounded-full hover:bg-cream/10 transition-colors">
                ...
                <div className="pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-cream/40 text-sm">
                        © 2026 Africa Mezziah. All rights reserved.
                    </p>
